...
const ManageBooking = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:9000/api/Booking/security') // Adjust this endpoint as needed
            .then(response => {
    ...
    const handleAction = (bookingId, actionType) => {
        ...
        axios.put(`http://localhost:9000/api/Booking/${bookingId}/${actionType}`) // Adjust this endpoint as needed
            .then(response => {
